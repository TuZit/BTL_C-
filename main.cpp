...
public:
    ...
    User(string uname, string pwd, string fname, bool autoGen = false, int pts = 0, int transCount = 0)
    {
        username = uname;
...
void viewUserDetails(User *currentUser)
{
    cout << "\nUser Details:" << endl;
    cout << "Full Name: " << currentUser->fullName << endl;
    cout << "Points: " << currentUser->points << endl;
    cout << "Number of Transactions: " << currentUser->transactionCount << endl;
}
